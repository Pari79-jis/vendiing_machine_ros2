...
static const _VendingMachine_Request_type_support_symbol_names_t _VendingMachine_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vending_machine_interfaces, srv, VendingMachine_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vending_machine_interfaces, srv, VendingMachine_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, vending_machine_interfaces, srv, VendingMachine_Request)() {
  return &::vending_machine_interfaces::srv::rosidl_typesupport_c::VendingMachine_Request_message_type_support_handle;
}
...
static const _VendingMachine_Response_type_support_symbol_names_t _VendingMachine_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vending_machine_interfaces, srv, VendingMachine_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vending_machine_interfaces, srv, VendingMachine_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, vending_machine_interfaces, srv, VendingMachine_Response)() {
  return &::vending_machine_interfaces::srv::rosidl_typesupport_c::VendingMachine_Response_message_type_support_handle;
}
...
static const _VendingMachine_type_support_symbol_names_t _VendingMachine_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vending_machine_interfaces, srv, VendingMachine)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vending_machine_interfaces, srv, VendingMachine)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, vending_machine_interfaces, srv, VendingMachine)() {
  return &::vending_machine_interfaces::srv::rosidl_typesupport_c::VendingMachine_service_type_support_handle;
}
